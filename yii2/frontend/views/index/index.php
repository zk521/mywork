...
<frameset rows="51,*" framespacing="0" border="0">
  <frame src="inc/top.html" id="header-frame" name="header-frame" frameborder="no" scrolling="no">
  <frameset cols="180, 10, *" framespacing="0" border="0" id="frame-body">
    <frame src="inc/menu.html" id="menu-frame" name="menu-frame" frameborder="no" scrolling="yes">
    <frame src="" id="drag-frame" name="drag-frame" frameborder="no" scrolling="no">
    <frame src="inc/main.html" id="main-frame" name="main-frame" frameborder="no" scrolling="yes">
  </frameset>
</frameset>
