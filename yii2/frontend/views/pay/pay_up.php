...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
     <form enctype="multipart/form-data" action="index.php?r=pay/up_pay" method="post">
                ...
                <tr>
                    ...
                    <td>
                        <div>
                           ...
                           <input type="radio" name="pay_id" value="<?php echo $value['pay_id']?>"  
                           <?php if($value['pay_id']==$info['pay_id']){echo 'checked';}?>/>
...
<tr>
                    ...
                    <td>
                        <div>
                          <input type="text" name="pay_price" value="<?php echo $info['pay_price']?>" />
                        <br>
